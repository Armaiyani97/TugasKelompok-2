...
<html>
    ...
    <body>
        <form method="post" action="edit.php">
            ...
            <table>
                <tr><td>Nama</td><td><input type="text" value="" name="id_barang"></td></tr>
                <tr><td>Alamat</td><td><input type="text" value="" name="nama_barang"></td></tr>
                <tr><td>No.Hp</td><td><input value="" type="text" name="harga_lama"></td></tr>
		<br>
		<br>
		<br>
			...
			<div align="center">
			<input type="radio" name="bayar" value="COD" checked>COD
			<input type="radio" name="bayar" value="Transfer" checked>Transfer <br>
			<!-- <input type="checkbox" name="checxbox" value="COD" checked>COD 
			<input type="checkbox" name="checxbox" value="Transfer" checked>Transfer<br> -->
			<tr><td colspan="2"><button type="submit" value="simpan" >Submit</button> </div>
        </form>
    </body>
</html>
