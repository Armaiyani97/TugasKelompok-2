	...
	<div class="container">
		...
		<form action="auth.php" method="post">
			...
			<form>
				...
				<h5> Username *</h5>
				<input type="text" class="form-control input-sm chat-input" placeholder="Username" name="username" required=" " />
				<h5> Email *</h5>
           		<input type="text" id="userName" class="form-control input-sm chat-input" placeholder="Email" name="email" required=" "/>
           		<h5> Password *</h5>
           		<input type="password" id="userPassword" name="password" class="form-control input-sm chat-input" placeholder="Password" required=" "style="margin-bottom: 16px; margin-top: 0px;"/>
           		<h5> Konfirmasi Password</h5>
           		<input type="password" id="userPassword" name="konfirmasi_password" class="form-control input-sm chat-input" placeholder="konfirmasi Password" required=" "style="margin-top: 0px; margin-right: 16px;"/>
